...
Revision ID: 61f7e40b7bb8
Revises: c7cc20358826
Create Date: 2022-10-15 22:43:09.495265
...
revision = '61f7e40b7bb8'
down_revision = 'c7cc20358826'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table('chinese_word',
    sa.Column('create_time', sa.DateTime(), nullable=True),
    sa.Column('update_time', sa.DateTime(), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('text', sa.String(length=800), nullable=True, comment=u'text of chinese word'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('user_learned_chinese_words',
    sa.Column('create_time', sa.DateTime(), nullable=True),
    sa.Column('update_time', sa.DateTime(), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('cn_word_id', sa.Integer(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    ...
    op.drop_table('user_learned_chinese_words')
    op.drop_table('chinese_word')
    # ### end Alembic commands ###
